...
class CloveConan(ConanFile):
    ...
    requires = "assimp/5.0.1", "bullet3/3.07", "freetype/2.10.4", "gtest/1.10.0", "libsndfile/1.0.30", "openal/1.21.0", "shaderc/2021.1", "spdlog/1.8.2", "spirv-cross/cci.20211113", "yaml-cpp/0.6.3"
